...
export const environment: IEnvironment = {
	...
	appIntegrationConfig: {
		appName: process.env.APP_NAME || 'Khata',
		appLogo: process.env.APP_LOGO || `${process.env.CLIENT_BASE_URL}/assets/images/logos/logo_Gauzy.png`,
		appSignature: process.env.APP_SIGNATURE || 'Khata',
		appLink: process.env.APP_LINK || process.env.CLIENT_BASE_URL || 'http://localhost:4200',
		...
		companyLink: process.env.COMPANY_LINK || process.env.CLIENT_BASE_URL || 'http://localhost:4200',
		companyName: process.env.COMPANY_NAME || 'Khata'
	},
