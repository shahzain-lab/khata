...
import { DEFAULT_API_PORT, DEFAULT_GRAPHQL_API_PATH, DEFAULT_API_BASE_URL } from '@gauzy/constants';
import {
...
export const pluginConfig: ApplicationPluginConfig = {
	apiConfigOptions: {
		// Railway/Fly set PORT; bind 0.0.0.0 so platform healthchecks work
		host: process.env.API_HOST || '0.0.0.0',
		port: process.env.API_PORT || process.env.PORT || DEFAULT_API_PORT,
